...
# TO DO: Make sure it is Azure Kinect base frame name
_BASEC.VSLAM.VSLAM_BASE_FRAME = "/camera_base"
# RGB camera center frame name
# TO DO: Make sure it is Azure Kinect RGB camera frame name
_BASEC.VSLAM.RGB_CAMERA_CENTER_FRAME = "/rgb_camera_link"
# minimum depth values to be considered as valid
_BASEC.VSLAM.DEPTH_MIN = 0.25
# maximum depth values to be considered as valid
_BASEC.VSLAM.DEPTH_MAX = 2.88
# configuration file name for ORB-SLAM2
_BASEC.VSLAM.CFG_FILENAME = "azurekinect.yaml"
